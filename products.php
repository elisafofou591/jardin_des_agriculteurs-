...
$sql = "
    SELECT
        ...
        p.prix, p.stock, p.unite, p.image, p.statut,
        c.nom_categorie,
        f.nom_fournisseur
    FROM produits p
...
<div><h3>Mon espace</h3><p><a href="panier.php">Mon panier</a></p><p><a href="commande.php">Mes commandes</a></p><p><a href="connexion.php">Connexion</a></p></div>
</div>
